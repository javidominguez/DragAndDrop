...
| Nombre del script | teclado de escritorio | Teclado de portátil | Descripción |
| - | - | - | - |
| mouseCursorInfo | NVDA+- | NVDA+Control+, | Informa sobre la posición del cursor del ratón y el objeto al que apunta. Pulsado dos veces, informa sobre el objeto marcado para arrastrar y soltar. |
...
- Pulsa las flechas para soltar alrededor del objeto actual en el navegador.
