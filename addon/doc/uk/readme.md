...
| - | - | - | - |
| mouseCursorInfo | NVDA+- | NVDA+Control+, | Повідомляє позицію курсора мишки і об’єкт, на який він вказує. Подвійне натискання повідомляє назву об’єкта, позначеного для перетягування. |
